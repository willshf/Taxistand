...
public class Queue<ContentType> {
	...
	public void enqueue(ContentType pContent) {
		if (pContent != null) {
			QueueNode newNode = new QueueNode(pContent);// neuen Knoten anfertigen + inhalt einfügen
			if (this.isEmpty()) {
				head = newNode;
				tail = newNode;
			} else {
				tail.setNext(newNode); // Referenz wird gesetzt
				tail = newNode; // tail auf neues Ende setzen
			}
		}
	}
